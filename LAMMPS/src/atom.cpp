...
void Atom::peratom_create()
{
  ...
  // USER-DEMSI package 
  add_peratom("forcing",&forcing,DOUBLE,2);
  add_peratom("mean_thickness",&mean_thickness,DOUBLE,1);
  add_peratom("min_thickness",&min_thickness,DOUBLE,1);
  add_peratom("ridgingIceThickness",&ridgingIceThickness,DOUBLE,1);
  add_peratom("ridgingIceThicknessWeight",&ridgingIceThicknessWeight,DOUBLE,1);
  add_peratom("netToGrossClosingRatio",&netToGrossClosingRatio,DOUBLE,1);
  add_peratom("changeEffectiveElementArea",&changeEffectiveElementArea,DOUBLE,1);
  add_peratom("ice_area",&ice_area,DOUBLE,1);
  add_peratom("coriolis",&coriolis,DOUBLE,1);
  add_peratom("ocean_vel",&ocean_vel,DOUBLE,2);
  add_peratom("bvector",&bvector,DOUBLE,2);
