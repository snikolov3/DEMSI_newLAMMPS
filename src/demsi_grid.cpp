...
namespace DEMSI {
  ...
  void Grid::interpolation_weights(kokkos_view_type_x particles_x, Kokkos::View<int*[4]> i, Kokkos::View<int*[4]> j, Kokkos::View<double*[4]> weight) {
    ...
    printf("\n\n\n\n\n%lu\n\n\n\n\n\n", particles_x.extent(0));
    Kokkos::parallel_for("Grid::interpolation_weights1", Kokkos::RangePolicy<device_execution_space>(0, particles_x.extent(0)), KOKKOS_LAMBDA(const int iParticle) {
