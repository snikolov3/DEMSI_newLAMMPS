...
parser.add_argument('-t', '--nThreads', dest='nThreads', type=int , default=4,
...
# run smoke test
returnCode = subprocess.call(["mpirun", "-np", str(args.nProcs), args.demsiExecutable, demsiConfigFileTest,"-kokkos","threads","%d"%args.nThreads,"numa","1"])
